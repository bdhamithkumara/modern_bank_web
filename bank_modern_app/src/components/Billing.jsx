    ...
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
          <img src={apple} alt="appstore logo" className="w-[128px] h-[128px] object-contain mr-5 cursor-pointer"/>
          <img src={google} alt="playstore logo" className="w-[128px] h-[128px] object-contain mr-5 cursor-pointer"/>
        </div>
      </div>
    </section>
)
